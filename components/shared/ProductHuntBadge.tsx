...
export function ProductHuntBadge({
  ...
  return (
    <a
      ...
      className={`inline-flex shrink-0 items-center transition-opacity hover:opacity-80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${className ?? ""}`}
