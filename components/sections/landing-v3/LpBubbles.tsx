 ...
 * infinite — the .lp-anim-bubble keyframe). The bubbles are near-circles, so
 * the spin is visually near-static: faithful to the Figma prototype, where the
 * bubbles' rotation wrappers coincide with the circles themselves.
 *
 ...
 * narrower than tall — hence per-bubble w/h. The four bubbles that run
 * phase-offset tracks in Figma (same +360° delta, shifted start angle) sit in
 * rotated wrappers; their sampled sizes ARE the rotated shape, and the offset
 * phase is kept via negative animation-delay:
 *   delay = −(20s − offset°/18°s⁻¹), e.g. −125.658° → −13.019s.
 *
...
interface Bubble {
  ...
  h: number;
  color: string;
  /** negative animation-delay (s) for the phase-offset Figma tracks */
  delay?: number;
...
const BUBBLES: Bubble[] = [
  ...
  { cx: 781.23, cy: 342.79, w: 32.14, h: 31.1, color: "#ff7aa0", delay: -13.019 },    // 4420:986 (−485.658→−125.658)
  { cx: 741.47, cy: 399.56, w: 32.27, h: 31.45, color: "#ff7aa0", delay: -13.479 },   // 4420:991 (−477.384→−117.384)
  { cx: 894.22, cy: 331.79, w: 32.14, h: 31.11, color: "#ba8bff", delay: -13.019 },   // 4420:996 (−485.658→−125.658)
  ...
  { cx: 871.73, cy: 368.73, w: 28.34, h: 28.65, color: "#ba8bff", delay: -19.763 },   // 4420:1111 (−364.269→−4.269)
