...
export const DEMO_EVENTS: ScanEvent[] = [
  ...
  { type: "citation", index: 1, cited: false, detail: "Cited instead: solvhealth.com, zocdoc.com" },
  ...
  { type: "citation", index: 4, cited: false, detail: "Cited instead: calendly.com, acuityscheduling.com" },
  { type: "citation", index: 5, cited: true, detail: "ChatGPT names you in this answer." },
  { type: "citation", index: 6, cited: false, detail: "Cited instead: zocdoc.com" },
  ...
  { type: "status", label: "Adding it up…" },
  {
    ...
    items: [
      ...
      {
        title: "12 page-2 searches within reach",
        detail: "High-intent booking searches sit at positions 11 to 17. Focused pages move those inside a quarter.",
      },
      {
        title: "Ship an llms.txt",
        detail: "Twenty minutes of work that tells every AI system exactly what you do and who you serve.",
      },
    ],
  },
  { type: "score", value: 62 },
