...
faq:
  ...
  - question: "What is Pancake?"
    answer: "Pancake is AI co-founder infrastructure for autonomous companies. It takes you from $1 to $1M in revenue without hiring, by deploying AI agents that run your operations — growth, engineering, content, coordination — 24/7. It works solo or multiplayer, runs natively in the channels you already use (Slack, iMessage, email), and keeps humans in the loop for decisions that matter. Pancake runs on Pancake."
---
...
## Autonomous company vs. traditional startup: the key differences

| | Traditional Startup | Autonomous Company |
|--|--|--|
| How it scales | Hire headcount | Deploy agents |
| Cost to scale | $80–200K per hire | $49/month (Pancake) |
| Working hours | 40/week per person | 24/7 |
| Iteration speed | Weeks (HR → onboard → ramp) | Hours (update config → re-deploy) |
| Who handles ops | Operations hire | Ops agent |
| Who handles GTM | SDR + BDR team | Growth agent |
| Who handles engineering coordination | Engineering team | Engineering agent |
| Founder's job | Manager | Decision-maker |
