...
Agents that do not share context make inconsistent decisions. Pancake v2 addresses this inside GTM: buying-signal, outreach, and AI-search agents all use the same GTM Brain, so lead selection, messaging, and published content reflect the same positioning and evidence.
