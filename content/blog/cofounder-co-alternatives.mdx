...
|----------|----------------|------------------|----------|
| Pancake | Schedule-driven, exception-based escalation | Pancake uses its own GTM agents ($30K MRR, $500-700/mo infra) | Founders past validation who want operations to run without daily prompting |
