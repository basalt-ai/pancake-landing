...
| **Pancake v2** | L4 within GTM | Recurring signals, outreach, and publishing | Small companies that need autonomous GTM execution |
...
**Pancake v2** runs recurring GTM work, coordinates agents through one Brain, and escalates decisions that require human judgment. It focuses on GTM rather than replacing hires in every company function.
