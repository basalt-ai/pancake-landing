...
zed agents — each one owns a function of your company.
...
| **Proof of concept** | Pancake uses its own GTM agents | N/A |
...
## The Proof Point: Pancake uses its own GTM agents
