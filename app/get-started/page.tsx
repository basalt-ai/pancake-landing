...
const appLeadMagnetHref =
  "https://app.getpancake.ai?utm_source=lead_magnet&utm_medium=owned&utm_campaign=get_started";
        ...
        <div className="main">
          ...
          <div className="right">
            ...
            <div className="gs-card">
              ...
              <a className="btn-google" href={appLeadMagnetHref}>
              ...
              <a className="btn-cta" href={appLeadMagnetHref}>
                Continue
